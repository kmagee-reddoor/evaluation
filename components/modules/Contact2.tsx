    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container max-w-lg">
        <div className="mx-auto mb-8 w-full max-w-lg text-center md:mb-10 lg:mb-12">
          ...
          <p className="md:text-md">Have a question? We're here to help.</p>
        </div>
          ...
          <div className="grid w-full items-center py-3 md:py-4">
            ...
            <RadioGroup className="grid grid-cols-2 gap-x-6 gap-y-3.5">
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#first_choice" />
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="#fourth_choice">Fourth choice</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="First choice" id="#fifth_choice" />
                <Label htmlFor="#fifth_choice">Fifth choice</Label>
              </div>
              <div className="flex items-center space-x-2">
